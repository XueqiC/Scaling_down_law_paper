...
model of that arm; the teacher never plays the role of the source. The observable is a likelihood on a
fixed distribution, not an accuracy, and absolute levels of different tokenizers are never placed on
one scale (Appendix~\ref{sec:app_measure}).
