...
Section~\ref{sec:observed} established what a law must reproduce, we now next examine which response structures can be shared across capabilities, how model state and training protocol affect prediction, and how logit displacement accounts for compression damage. 
