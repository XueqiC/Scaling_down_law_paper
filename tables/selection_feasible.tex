...
\caption{Feasible leave-one-state-out selection by policy and objective: feasibility coverage and oracle-method agreement in percent and mean regret in nats. Own denotes the cells feasible for that policy and common the cells feasible for each policy. This is a \mbox{post-hoc} development evaluation.}
