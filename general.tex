...
fitted at all (Fig.~\ref{fig:efficiency}a). On OLMo-2, six development states of 1B and 7B and four
test states in no fit, with every predictor refitted and frozen before the test, the form fitted on
12 configurations errs by 0.017 and
...
\begin{subfigure}[t]{1.8in}\centering\includegraphics[width=\linewidth]{figs/eff_b.pdf}\caption{OLMo-2, half against full grid}\end{subfigure}\hfill
\begin{subfigure}[t]{1.8in}\centering\includegraphics[width=\linewidth]{figs/eff_c.pdf}\caption{Cost of the reduced grid}\end{subfigure}
...
as a share of the full grid, with anchors and loading counted in both grids.}
