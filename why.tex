...
0.94 and 0.97). Richer descriptors did not repair transfer: dense pre-compression statistics improve a
...
gains on none of the nine primary pairs (Appendix~\ref{sec:app_inputs}). The state helps where the response shape is shared across states and not where it is not.
...
ordering survives at every rate. At a fixed rate the independent-data axis dominates: the reuse cost is
