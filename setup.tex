...
every state compared within a model. The reference model $M_0$ is the checkpoint before the compression intervention. Responses are within-model differences on
