...
\caption{The table evaluates feasible leave-one-state-out selection. Coverage and oracle-method agreement are percentages; regret is in nats. Own and common refer to the subsets defined at the end of the caption. Rows identify policies and objectives; columns give feasibility coverage, mean regret, and oracle-method agreement. This is a \mbox{post-hoc} development evaluation. Own means the cells feasible for that policy; common means cells feasible for each policy.}
